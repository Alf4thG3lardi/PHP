...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        <div class="mb-3 w-50">
            ...
            <input type="text" name="menu" id="" required placeholder="Isi nama menu" class="form-control">
        </div>
        <div class="mb-3 w-50">
            <label for="" class="form-label">Harga:</label>
            <input type="number" name="harga" id="" number required placeholder="Isi nama menu" class="form-control">
        </div>
        <div class="mb-3 w-50">
